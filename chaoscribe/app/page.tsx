                        ...
                        return (
                            <div key={i} className="flex flex-col justify-between w-7/12 h-96 p-4 mb-4 bg-white border rounded-lg shadow-md dark:border-gray-700 my-7">
                                ...
                                <div className="items-end flex items-center justify-around mt-4"> 
                                    <div>
                                        <button className="flex items-center px-3 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-600" onClick={() => { console.log('like') }}>
                                    ...
                                    <div>
                                        <button className="flex items-center px-3 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-600" onClick={() => setCommentingArticleId(article.id)} >
                                    ...
                                    <div>
                                        <button className="flex items-center px-3 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-600" onClick={() => { console.log('comment') }}>
